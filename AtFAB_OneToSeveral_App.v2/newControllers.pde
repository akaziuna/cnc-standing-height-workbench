void newControllers() {
  ...
  lengthC=map(table_Length,600,2000,175+3,175+260-3);                    
  fill(white);
  rect(lengthC-6,681+5-3,12,6);
  fill(orange);
  ellipse(lengthC,681+5,3,3);
  
  widthC=map(table_Width,600,2000,175+3,175+260-3);
  fill(white);
  rect(widthC-6,695+5-3,12,6);
  fill(orange);
  ellipse(widthC,695+5,3,3);
  
  heightC=map(table_Height,750,1100,175+3,175+125-3);
  fill(white);
  rect(heightC-6,748+5-3,12,6);
  fill(orange);
  ellipse(heightC,748+5,3,3);
  ...
  stroke(0);
  strokeWeight(.75);
  rect(325,748,50,10);//units outline
  noStroke();
  ...
  if(mouseX>=325 && mouseX<=375 && mouseY>=748 && mouseY<=758 && mousePressed && start==false) {
    if(mousePressed){
      u_Mouse=true;
    }
  }
...
//table_Width
  ...
  if(mouseX>=175 && mouseX<=175+125 && mouseY>=748 && mouseY<=748+10 && start==false) {
    if(mousePressed==true) {
      height_Mouse=true;
    }
  }
  ...
  if(height_Mouse == true) {
    table_Height = round((constrain(int(map(mouseX,175,175+125-5,750,1100)),750,1100))/5)*5;
  }
//table_Height
